...
void test( const LogicalStatementParser &test_parser, const std::string &expected )
{
...
int main( int argc, char const *argv[] )
{
    if( true )
    {
        test( " a & b & c & space space", "a & b & c & space space" );
    ...
    if( true )
    {
        test( LogicalStatementParser( "a & b" ) | LogicalStatementParser( "c & d" ), "a & b | c & d" );
        test( LogicalStatementParser( "a & b" ) | LogicalStatementParser( "a & b" ), "a & b" );
        test( LogicalStatementParser( "a & b" ) | LogicalStatementParser( "a" ), "a & b | a" );
    }
